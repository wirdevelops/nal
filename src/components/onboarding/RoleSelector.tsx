...
import { Film, Camera, Users, Building, ShoppingBag, Heart, Sparkles } from 'lucide-react';
...
const ROLES: {
  ...
  },
  {
    ...
    icon: Sparkles,
    title: 'App User',
    description: 'Purchase goods or services on the platform',
  },
  {
    id: 'vendor',
    icon: ShoppingBag,
  ...
  },
  {
    ...
    icon: Heart,
    title: 'NGO Admin',
    description: 'Manage NGO collaborations and impact projects'
  }
];
