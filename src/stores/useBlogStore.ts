...
interface BlogStore {
  ...
  updatePostAnalytics: (postId: string, data: Partial<BlogPost['analytics']>) => void;
}
      ...
      addPost: async (data) => {
        try {
            ...
            const newPost: BlogPost = {
                ...
                metadata: {
                    wordCount: calculateWordCount(validatedData.content),
...
function calculateReadingTime(content: BlogPost['content']): number {
